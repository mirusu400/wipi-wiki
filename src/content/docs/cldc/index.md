...
WIPI 1.2.1 의 자바 언어 지원은 본 규격을 기준으로 합니다 ([platform.md 3.9.1 참조](../overview/platform)).

| 항목 | 내용 |
|---|---|
| [규격서](spec/) | CLDC 1.1 본문 — 가상 머신/라이브러리/보안 요구 사항 |
| [바이트 코드 검사기](verifier/) | CLDC 부록 1 — KVM 런타임 유형 검사기 규격 (Prolog 절 형식 규격) |
| [Java API](java-api/) | CLDC 핵심 라이브러리 — `java.io`, `java.lang`, `java.lang.ref`, `java.util`, `javax.microedition.io` (5 패키지, 81 클래스) |
