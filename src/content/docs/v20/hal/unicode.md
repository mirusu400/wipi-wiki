...
```c
M_Int32 MH_utilConvertLocalCodesToUnicodes (M_Char *psz, M_Int32 len, M_Uint16 *puni, M_Int32 buflen)
```
...
```c
M_UInt16 MH_utilConvertLocalCodeToUnicodeChar(M_Uint8 *psz,
...
```c
M_UInt32 MH_utilLocalCodeSizeToUnicodeChar(M_Uint16 *psz,
M_Int32 len);
```
