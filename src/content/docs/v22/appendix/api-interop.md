---
title: "1. MSF/MSP와 CLDC/MIDP의 API 혼용 기"
---

준 WIPI2.0에서는 MSF/MSP와 CLDC/MIDP API 중에는 같은 기능을 하는 것들이 중복되어 있다. 따라서, 구현된 플랫폼에 따라 혼용 시 문제가 될 수 있으므로 플랫폼은 다음에 기술된 사항을 준수하는 수준에서 호환성이 보장 되어야 한다. WIPI2.0에서 CLDC/MIDP API 사용 기준을 규정하기 위해 관련 패키지들을 다음 3가지 유형으로 분류하여 기준을 정하였다. 첫째, 동일한 패키지 이름을 가지는 부분으로 플랫폼은 동일한 기능을 제공해야 한다.
