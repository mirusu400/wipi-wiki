...
장치
MH_MDAINFO_CALL_BY_REFERENCE = 0x0002, // 전달하는 버퍼내용을 복
사하지 않고 그대로 사용함
MH_MDAINFO_PAUSE_RESUME = 0x0004, // pause/resume을 지원하
는 장치
MH_MDAINFO_SEEK = 0x0008 // seek을 지원하는 장치
MH_MDAINFO_STREAM_RECORD = 0x0010, // STREAM 녹음을 지원하는
장치
} MH_MdaDevInfo;
// 사운드 이벤트
...
M_Int32 size; /* MH_MDAEV_MEDIA_EMPTY , MH_MDAEV_TONE_EMPTY 인 경
우, 미디어장치 내부버퍼에 받아 들일 수 있는 데이터 양,
